...
function FinHeader() {
  return (
    <div className=" w-full">
      <div className="  flex flex-col lg:flex-row " style={{ height: "300px" }}>
        <div className=" container mx-autoflex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
          <div>
