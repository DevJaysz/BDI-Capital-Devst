  ...
  return (
    <>
      ...
      <div className="text-center max-w-6xl mx-auto z-10">
        <p className="mb-4 text-sm md:text-2xl text-gray-300">
        ...
        <p className="mb-8 text-sm md:text-2xl text-gray-300">
          We take care of your backend so you can focus on your frontend.
        </p>
        <h1 className="text-3xl md:text-3xl lg:text-4xl xl:text-6xl font-extrabold mb-6 text-gray-900 dark:text-white">
