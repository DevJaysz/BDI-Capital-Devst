  ...
  return (
    <section id="features" className="flex flex-col items-center ">
      <div className="flex flex-col items-center gap-12 text-center">
        <h2 className="text-2xl md:text-5xl font-bold bg-gradient-to-b from-[#F0AE4F] to-gray-400 bg-clip-text text-transparent">
          OUR MISSION IS TO CREATE FIRST-WORLD INNOVATIONS
        </h2>
        <p className="text-lg text-gray-300 max-w-6xl">
