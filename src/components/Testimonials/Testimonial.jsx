    ...
    <main className="relative z-20 w-full mt-8 md:mt-12 flex flex-col items-center md:items-center">
      ...
      <div className="w-full max-w-4xl p-6 flex flex-col items-center md:flex-row md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
        ...
        <div className="mt-4 md:mt-0 md:mx-6 text-center md:text-left">
          ...
          I have tried a lot of mentorship for my
          company and personally, and mentorship with BDI Capital has been one of the best for me. James and I went out for dinner, and he connected me with his personal
          contacts. 
         <br /> <br />
          As a company, BDI is helping us prepare for our next fundraising and
          financial strategy. The advice we receive is concrete and actionable, and I would definitely recommend other startups to work with them!
           <br/>NPS Score 10!
          </p>
