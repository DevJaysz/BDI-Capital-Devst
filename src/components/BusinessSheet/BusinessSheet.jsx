  ...
  return (
    ...
    <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-6 items-center">
      ...
      <div className="lg:pr-6">
        <h1 className="pb-4 text-4xl md:text-5xl xl:text-6xl font-bold text-[#F0AE4F]">
          We handle the backend, so you can focus on the frontend.
        </h1>
        <p className="pb-6 max-w-lg text-sm md:text-lg font-light text-gray-300 sm:text-base lg:pb-10 text-justify">
